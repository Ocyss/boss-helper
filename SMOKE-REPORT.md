...
- 交付 ZIP SHA256：`FD7113C610BD2BECAA614AB6E634B08D7A8BCD8E4C6F9E98276D97BB1395FF3A`。
...
- 本轮未开启“自动投递（含招呼语）”、批次长等待或图片简历发送，未用真实账号调用投递或聊天发送；这些功能仅完成默认关闭、配置入口、发送顺序和 fail-closed 守卫的静态验证。
