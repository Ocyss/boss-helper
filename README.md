...
本仓库是基于 [Ocyss/boss-helper](https://github.com/Ocyss/boss-helper) `0.4.4` 的个人维护改版。原项目采用 MIT License，原始版权与许可证声明保留在 [LICENSE](LICENSE) 中。

当前改版主要补充了 AI/自定义招呼语发送兜底、聊天页队列发送面板、发送通道诊断，以及源码化维护这些改动所需的构建配置。
