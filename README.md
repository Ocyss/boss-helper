...
| 浏览器  | 开发者加载方式                                                                                     | 构建目录                            |
| ------- | -------------------------------------------------------------------------------------------------- | ----------------------------------- |
| Chrome  | 打开 `chrome://extensions`，开启“开发者模式”，点击“加载已解压的扩展程序”                           | `.output/chrome-mv3`                |
| Edge    | 打开 `edge://extensions`，开启“开发人员模式”，点击“加载解压缩的扩展”                               | `.output/edge-mv3`                  |
| Firefox | 打开 `about:debugging#/runtime/this-firefox`，点击“临时载入附加组件”，选择目录中的 `manifest.json` | `.output/firefox-mv2/manifest.json` |
